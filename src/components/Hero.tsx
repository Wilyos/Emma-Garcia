...
N:García;Emma;;;
ORG:IPROCOM S.A.
TITLE:Coordinadora de compras
TEL:+573042785452
EMAIL:egarcia@iprocom.co
...
END:VCARD`;
    ...
    link.href = url;
    link.download = 'Emma_Garcia_IPROCOM.vcf';
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-1 lg:order-2">
            ...
            <p className="text-xl lg:text-2xl text-foreground mb-8 leading-relaxed">
              Coordinadora de compras en IPROCOM.
            </p>
            ...
            <div className="flex justify-center lg:justify-start space-x-6">
              {[
                ...
                { icon: Mail, href: "mailto:egarcia@iprocom.co", label: "Email" }
